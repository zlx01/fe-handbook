...
```bash
npm i -D webpack webpack-cli typescript
```
...
dist/bundle.js
```js
console.log(0),setTimeout((function(){console.log("我一路向北，离开有你的季节")}),1e3);
```
...
dist/bundle.js
```js
(()=>{var o;!function(o){o[o.Fish=0]="Fish"}(o||(o={})),console.log(o.Fish),setTimeout((()=>{console.log("我一路向北，离开有你的季节")}),1e3)})();
```
